...
public class HttpUtil {
    ...
    public static String doGet(String url, Map<String, Object> params) {
       InputStream inputStream = doGetInputStream(url, params);
       if(inputStream != null){
           try {
    ...
    public static InputStream doGetInputStream(String url, Map<String, Object> params) {
        ...
        try {
            ...
            logger.info("page download statusCode:{}, url:{}", statusCode, url);
    ...
    public static String doPostSSL(String apiUrl, Map<String, Object> params) {
        CloseableHttpClient httpClient = HttpClients.custom().setSSLSocketFactory(createSSLConnSocketFactory()).setConnectionManager(poolingHttpClientConnectionManager).setDefaultRequestConfig(requestConfig).build();
        HttpPost httpPost = new HttpPost(apiUrl);
        CloseableHttpResponse response = null;
        String httpStr = null;
    ...
    public static void main(String[] args) throws Exception {
        String content = HttpUtil.doGet("https://www.fbo.gov/index?s=opportunity&mode=list&tab=list&tabmode=list&pp=100");
